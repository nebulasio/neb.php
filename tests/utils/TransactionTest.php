...
class TransactionTest extends TestCase
{
    ...
    public function prepare(){
        ...
        $this->tx = new Transaction($chainID, $from, $to, $value, $nonce, $payloadType, $payload, $gasPrice, $gasLimit);


    }

    public function testParseContract()
    {
    ...
    public function testDataProto()
    {
        $this->prepare();
        $payLoad = new TransactionBinaryPayload("data");
        $payloadType = Transaction::BINARY;

        $data = $this->tx->dataProto($payloadType,$payLoad);
